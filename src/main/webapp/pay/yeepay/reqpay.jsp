...
<%
	...
	String keyValue	= formatString(SystemSet.paytype.getProperty("yeepay_key"));	// 鍟嗗瀵嗛挜
	String nodeAuthorizationURL = formatString(SystemSet.paytype.getProperty("yeepay_pay"));// 浜ゆ槗璇锋眰鍦板潃
	// 鍟嗗璁剧疆鐢ㄦ埛璐拱鍟嗗搧鐨勬敮浠樹俊鎭?
	String p0_Cmd = formatString("Buy");// 鍦ㄧ嚎鏀粯璇锋眰锛屽浐瀹氬€?鈥滲uy鈥?
	String p1_MerId = formatString(SystemSet.paytype.getProperty("yeepay_pid"));// 鍟嗘埛缂栧彿
	...
	String p8_Url = formatString(SystemSet.paytype.getProperty("yeepay_url"));// 鍟嗘埛鎺ユ敹鏀粯鎴愬姛鏁版嵁鐨勫湴鍧€
